    ...
    <div class="container-fluid w-auto">
        <div class="col py-5 ps-5 pe-3">
            ...
            <div class="d-flex justify-content-between my-3">
                ...
                <a href="{{ url('teamedit') }}" class=" btn btn-primary"><i class="fa fa-plus"></i></a>
            </div>
            ...
            <ul class="list-group mt-3">
                ...
                <li class="list-group-item py-3 bg-dark text-light">
                    <div class="row d-flex align-items-center">
                        <div class="col-md-9 col-12 text-center text-md-start">
                            <p class="m-0 fs-5">Daniel Tebas</p>
                            <p class="lead">Chef</p>
                        </div>
                        <div class="col-md-3 col-12 d-flex justify-content-md-end justify-content-center mt-md-0 mt-3 align-items-center">
                            <div>
                ...
                <li class="list-group-item py-3 bg-dark text-light">
                    <div class="row d-flex align-items-center ">
                        <div class="col-md-9 col-12text-center text-md-start">
                            <p class="m-0 fs-5">Jon Snow</p>
                            <p class="lead">Chef</p>
                        </div>
