    ...
    <div class="container-fluidn col py-5 ps-5 pe-3">
        <div class="d-flex justify-content-between my-3">
            <div class="d-flex justify-content-end pt-lg-3">
                <a href="{{ url('dishes') }}"><i class=" bi bi-chevron-double-left"></i>Back</a>
            </div>
        </div>
        <div class="container">
            <div class="text-center">
                <h3>Dish List</h3>
                <p class="lead">Edit a Dish</p>
            </div>
            <div class="team-card">
        ...
        <div class="container-fluid p-0">
            <div class="p-5">
                <form class="col-6 offset-3 bg-dark p-3 rounded-3">
                    <div class="form-floating mb-3">
                        <input type="text" id="categoryName" class="form-control" placeholder="Enter Category Name">
                        <label for="categoryName">Dish Name</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="text" id="categoryName" class="form-control" placeholder="Enter Category Name">
                        <label for="categoryName">Menu Type</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="text" id="categoryName" class="form-control" placeholder="Enter Category Name">
                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-sm-6 col-12 d-flex justify-content-center my-2">
                            <button onclick="location.href='./Dishes.html'" class="btn btn-success px-5 fs-5" type="button">Save Changes</button>
                        </div>
                    </div>
                </form>
            </div>
