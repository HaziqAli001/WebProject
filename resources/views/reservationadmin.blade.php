    ...
    <div class="container-fluid w-auto">
        <div class="col py-5 ps-5 pe-3">
            ...
            <div class="d-flex justify-content-between my-3">
                ...
                <button onclick="" class="btn btn-primary"><i class="fa fa-plus"></i></button>
            </div>
            <div class="text-center">
                <h3>Reservations</h3>
                <p class="lead">Reserve Your de Café</p>
            </div>
            <ul class="list-group mt-3">
                <li class="list-group-item py-3 bg-dark text-light mb-2 rounded-2">
                ...
                <li class="list-group-item py-3 bg-dark text-light mb-2 rounded-2">
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-md-3 col-12 text-center text-md-start">
                            ...
                            <p class="lead text-center">Winowed</p>
                        </div>
                        <div class="col-md-3 col-12 d-flex justify-content-md-end justify-content-center mt-md-0 mt-3 align-items-center">
                            <div>
                                <p class="lead">17/06/2022</p>
                                <p class="lead">8:50 PM</p>
                            </div>
                        </div>
                    </div>
                    <div class="text-center">
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam modi eveniet fugiat earum, totam eligendi.</p>
                    </div>
                    <div class="text-center">
                ...
                <li class="list-group-item py-3 bg-dark text-light mb-2 rounded-2">
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-md-3 col-12 text-center text-md-start">
                            <p class="lead text-center">7</p>
                            <p class="lead text-center">Family</p>
                        </div>
                        <div class="col-md-3 col-12 d-flex justify-content-md-end justify-content-center mt-md-0 mt-3 align-items-center">
                            <div>
                                <p class="lead">23/06/2022</p>
                                <p class="lead">3:00 PM</p>
                            </div>
                        </div>
                    </div>
                    <div class="text-center">
                    ...
                    <div class="text-center">
                        <p>Status: <i class="bi bi-patch-check-fill text-success"></i></p>
                    </div>
                </li>
            </ul>
        </div>
