        ...
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-lg-6 hero-left">
                    ...
                    <div class="mb-2">
                        <a class="btn btn-primary btn-shadow btn-lg" href="menu.html" role="button">Explore Menu</a>
                ...
                <div class="row mt-5">
                    <div class="col-lg-5 col-md-6 align-self-center py-5">
                        ...
                        <div class="dishes-text">
                            ...
                            <a href="reservation.html" class="btn-primary mt-3">book a table</a>
                        </div>
                    </div>
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-lg-5 offset-lg-2 col-md-6 align-self-center order-1 order-md-2 py-5">
                        ...
                        <div class="dishes-text">
                            ...
                            <a href="reservation.html" class="btn-primary mt-3">book a table <span><i class="fa fa-long-arrow-right"></i></span></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-4 menu-wrap">
                        ...
                        <div class="menus d-flex align-items-center">
                            ...
                            <div class="text-wrap">
                                ...
                                <p>Meat Ball, Mie</p>
                                <a class="btn btn-primary btn-shadow btn-sm" href="menu.html" role="button">Add to
                                    cart</a>
